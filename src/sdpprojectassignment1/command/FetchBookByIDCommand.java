...
public class FetchBookByIDCommand extends DBCommand{
	...
	public FetchBookByIDCommand(Book book){
		this.book=book;
	}
	...
	public void executeCommand() {
		try{
			...
			System.out.println("Inside fetch book by id command printing query and conn");
			...
			/*while(resultset.next()){
				...
				System.out.println("Retrieved Book Details"+"BookId ="+book.bookID+"BookName="+book.bookName);
