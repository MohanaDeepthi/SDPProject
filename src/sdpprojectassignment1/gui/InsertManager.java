...
public class InsertManager extends JDialog {

	private static final long serialVersionUID = -3543235389732324387L;
	 ...
	 * Create the dialog.
	 */
	public InsertManager(final String bookType) {
						...
						if(textField.getText().isEmpty()||(textField_1.getText().isEmpty())||(textField_2.getText().isEmpty())||(textField_3.getText().isEmpty()) || (textField_4.getText().isEmpty()))
							...
							try{
								if(bookType.equalsIgnoreCase("textbook")){
									selectedBook = new TextBook(Integer.parseInt(textField.getText()),textField_1.getText(), textField_2.getText(), 
											textField_3.getText(), Double.parseDouble(textField_4.getText()), bookType, "insert");

								}else if(bookType.equalsIgnoreCase("digitalbook")){
									selectedBook = new DigitalBook(Integer.parseInt(textField.getText()),textField_1.getText(), textField_2.getText(), 
											textField_3.getText(), Double.parseDouble(textField_4.getText()), bookType, "insert");
								}
								bookOperationsController.saveBook(selectedBook);
								JOptionPane.showMessageDialog(null, "Data Submitted");
							}
							catch(Exception e){
								JOptionPane.showMessageDialog(null, "Invalid Data to insert:"+e.getMessage());
							}
